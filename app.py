...
st.set_page_config(page_title="Movie Browser | Home", page_icon=favicon, layout="wide")
...
st.markdown(
    ...
    <div class='row'>
        <div class='col>
            <p>Name: Yusra Noor </p>
            <p>School: Strathmore </p>
            <p>School id: 112635</p>
        </div>
    </div>
...
my_api_key = "99b7ffdd29d95f6854e7ca1c75a1ed1b"
...
subheading = '<p style="color:aliceblue; font-size: 20px;">Enter a movie name <span style="color:cyan;">The app will give you similar flicks...</span></p>'
